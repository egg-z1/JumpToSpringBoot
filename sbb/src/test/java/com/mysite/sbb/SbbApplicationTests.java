...
//        
//        // 학번으로 이름 구하기 
//        Students studentId = studentsRepository.findByStid("2214440");
//        assertEquals("김지현", studentId.getName());
//        
//        // 이름으로 학번 구하기
//        Students studentName = studentsRepository.findByName("김지현");
//        assertEquals("2214440", studentName.getStid());
//    }
}
